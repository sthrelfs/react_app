...
function SpeakerDemographics() {
  ...
  return (
    <div className="speaker-info">
      ...
      <SpeakerFavorite />
      <div>
        <p className="card-description">{bio.substr(0.90)}</p>
...
const SpeakerNoErrorBoundary =
  memo(function Speaker({ speaker, updateRecord, insertRecord, deleteRecord, showErrorCard }) {
...
// check to see if favorite star has changed
